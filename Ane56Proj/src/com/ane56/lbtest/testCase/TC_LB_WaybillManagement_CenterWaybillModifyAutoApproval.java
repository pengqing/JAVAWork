...
/**
 * 加盟网点中心运单修改审批(自动审批)流程1详情：运单发放 -> 运单发放查询 -> 寄件网点录单 -> 核对运单详情 -> 寄件运单管理(修改目的网点)
 * -> 目的网点运单调整确认 -> 寄件运单查询 -> 寄件网点发件扫描 -> 首分拨到件扫描 -> 首分拨发件扫描 -> 目的分拨到件扫描 ->
 ...
 * @modifyContent 与中心运单修改自动审批的流程合并
 * @version 1.3
 * @modifier WangHui
...
public class TC_LB_WaybillManagement_CenterWaybillModifyAutoApproval extends BasePage
{
	 ...
	 * 寄件网点录单
	 */
	@Test(groups = "RecordWaybill", dependsOnMethods = "issueWaybill", priority = 2, dataProvider = "DataProvider", dataProviderClass = DataProviders.class, description = "加盟网点中心运单修改审批(自动审批)&费用核对-寄件网点录单及校验")
	 ...
	 * 修改运单目的网点
	 */
	@Test(dependsOnMethods = "wpointRecordWaybill", priority = 2, dataProvider = "DataProvider", dataProviderClass = DataProviders.class, description = "加盟网点中心运单修改审批(自动审批)-修改运单目的网点")
	 ...
	 * 寄件网点发件扫描并进行发件扫描查询
	 */
	@Test(dependsOnMethods = "wpointWaybillAdjuestConfirm", priority = 2, dataProvider = "DataProvider", dataProviderClass = DataProviders.class, description = "加盟网点中心运单修改审批(自动审批)-寄件网点发件扫描并进行发件扫描查询")
